...
def index():
    ...
    # if statement checks for authorization and assigns all google data to a variable
...
def artist_registration():
    ...
    if request.method == 'POST':
        ...
        elif not primary_genre:
            flash('At least 1 Genre is required')
        else:
            new_artist = Artist(
                artist_name = name,
